...
The package mainly uses the `dw_edit_chart()` function from the __DatawRappr__ package, which you can learn [here](https://munichrocker.github.io/DatawRappr/reference/dw_edit_chart.html). You can read Datawrapper's API documentation [here](https://developer.datawrapper.de/reference).
